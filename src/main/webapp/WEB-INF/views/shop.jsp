                        ...
                        <div class="shop-product-wrap grid-view row mbn-40">
                                ...
                                <div class="product-item">
                                    <figure class="product-thumb">
                                        <a href="product-details.html">
                                            <img class="pri-img" src="${ctx}/res/css/img/product/product-1.jpg" alt="product">
                                            <img class="sec-img" src="${ctx}/res/css/img/product/product-3.jpg" alt="product">
                                        </a>
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="product-item">
                                    <figure class="product-thumb">
                                        <a href="product-details.html">
                                            <img class="pri-img" src="${ctx}/res/css/img/product/product-2.jpg" alt="product">
                                            <img class="sec-img" src="${ctx}/res/css/img/product/product-4.jpg" alt="product">
                                        </a>
                                        <div class="product-badge">
                                            <div class="product-label new">
                                                <span>new</span>
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="product-item">
                                    <figure class="product-thumb">
                                        <a href="product-details.html">
                                            <img class="pri-img" src="${ctx}/res/css/img/product/product-5.jpg" alt="product">
                                            <img class="sec-img" src="${ctx}/res/css/img/product/product-6.jpg" alt="product">
                                        </a>
                                        <div class="product-badge">
                                            <div class="product-label new">
                                                <span>new</span>
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="product-item">
                                    <figure class="product-thumb">
                                        <a href="product-details.html">
                                            <img class="pri-img" src="${ctx}/res/css/img/product/product-7.jpg" alt="product">
                                            <img class="sec-img" src="${ctx}/res/css/img/product/product-9.jpg" alt="product">
                                        </a>
                                        <div class="product-badge">
                                            <div class="product-label new">
                                                <span>new</span>
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="product-item">
                                    <figure class="product-thumb">
                                        <a href="product-details.html">
                                            <img class="pri-img" src="${ctx}/res/css/img/product/product-10.jpg" alt="product">
                                            <img class="sec-img" src="${ctx}/res/css/img/product/product-12.jpg" alt="product">
                                        </a>
                                        <div class="product-badge">
                                            <div class="product-label new">
                                                <span>new</span>
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="product-item">
                                    <figure class="product-thumb">
                                        <a href="product-details.html">
                                            <img class="pri-img" src="${ctx}/res/css/img/product/product-3.jpg" alt="product">
                                            <img class="sec-img" src="${ctx}/res/css/img/product/product-1.jpg" alt="product">
                                        </a>
                                        <div class="product-badge">
                                            <div class="product-label new">
                                                <span>new</span>
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="product-item">
                                    <figure class="product-thumb">
                                        <a href="product-details.html">
                                            <img class="pri-img" src="${ctx}/res/css/img/product/product-7.jpg" alt="product">
                                            <img class="sec-img" src="${ctx}/res/css/img/product/product-5.jpg" alt="product">
                                        </a>
                                        <div class="product-badge">
                                            <div class="product-label discount">
                                                <span>12%</span>
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="product-item">
                                    <figure class="product-thumb">
                                        <a href="product-details.html">
                                            <img class="pri-img" src="${ctx}/res/css/img/product/product-9.jpg" alt="product">
                                            <img class="sec-img" src="${ctx}/res/css/img/product/product-7.jpg" alt="product">
                                        </a>
                                        <div class="product-badge">
                                            <div class="product-label new">
                                                <span>new</span>
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="product-item">
                                    <figure class="product-thumb">
                                        <a href="product-details.html">
                                            <img class="pri-img" src="${ctx}/res/css/img/product/product-11.jpg" alt="product">
                                            <img class="sec-img" src="${ctx}/res/css/img/product/product-12.jpg" alt="product">
                                        </a>
                                        <div class="product-badge">
                                            <div class="product-label new">
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="product-item">
                                    <figure class="product-thumb">
                                        <a href="product-details.html">
                                            <img class="pri-img" src="${ctx}/res/css/img/product/product-8.jpg" alt="product">
                                            <img class="sec-img" src="${ctx}/res/css/img/product/product-6.jpg" alt="product">
                                        </a>
                                        <div class="product-badge">
                                            <div class="product-label new">
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="product-item">
                                    <figure class="product-thumb">
                                        <a href="product-details.html">
                                            <img class="pri-img" src="${ctx}/res/css/img/product/product-9.jpg" alt="product">
                                            <img class="sec-img" src="${ctx}/res/css/img/product/product-8.jpg" alt="product">
                                        </a>
                                        <div class="product-badge">
                                            <div class="product-label new">
                                                <span>new</span>
